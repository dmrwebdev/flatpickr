    ...
    function monthSelectPlugin(pluginConfig) {
        ...
        return function (fp) {
            ...
            function setCurrentlySelected() {
                ...
                fp.selectedDates.forEach(function (date) {
                    ...
                    if (targetYear === fp.currentYear) {
                        if (fp.rContainer) {
                            var monthElement = fp.rContainer.querySelector(".flatpickr-monthSelect-month:nth-child(" + (targetMonth + 1) + ")");
                            if (monthElement) {
            ...
            function setMonth(date) {
                ...
                switch (fp.config.mode) {
                    ...
                    case "multiple":
                        ...
                        var exists = selectedDates.some(function (d) {
